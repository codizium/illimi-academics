...
@section('content')
    <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
            <h1 class="fw-semibold mb-4 h6 text-primary-light">Add Academic Year</h1>
            <div>
    ...
    <div class="card">
        <div class="card-body">
            <form id="academicYearCreateForm" class="row g-3">
                <div class="col-md-6">
                    <label class="form-label">Name</label>
                    <input type="text" class="form-control" name="name" placeholder="2025/2026" value="{{ old('name') }}" />
                </div>
                <div class="col-md-6">
                    <label class="form-label">Slug</label>
                    <input type="text" class="form-control" name="slug" placeholder="2025-2026" value="{{ old('slug') }}" />
                </div>
                <div class="col-md-3">
...
@push('scripts')
    ...
    <script>
        bindAcademicAjaxForm({
            formSelector: '#academicYearCreateForm',
            url: @json(Route::has('v1.academics.academic_years.store') ? route('v1.academics.academic_years.store', [], false) : null),
            method: 'POST',
